...
if SourceCh(msg) and text == "سيطره" or text == "العالمي" then 
local vshicov_Msg = {
كسمك يا سيطره م حوار البوتات الي هتقل منك ع نا تقيل عليك😹😹....!؟"
كسمك يا عالمي علي كسم السيرفرين الي بتلف بييهم التلي 😹😹....!؟"
كسمك يا باندا يابن الغداره😹😹....!؟"
يا علمي يكس الكلبه يلي عايشها نصب يكسمك😹😹....!؟"
شيكو بيقولك تحت زبي 😹😹....!؟"
كسمك لاجل خيا تايكار😹😹....!؟"
} 
send(msg.chat_id_, msg.id_, [ ..vshicov_Msg[math.random(#vshicov_Msg)].. ] )  
return false 
end
