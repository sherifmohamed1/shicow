...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋𝐊𝐈𝐌𝐀Ꮇ', url="t.me/SOURCE_ELKIMA"},
},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•𝐌𝐄𝐒𝐒𝐈♪',url="t.me/Messi_ElKBer"},{text = '•𝐊𝐎𝐑𝐘♪', url="t.me/Bedo11111"}},
{{text = '˹𝐓𝐀𝐖𝐎𝐒𝐋˼',url="t.me/ELKIMA_BOT"}}, 
{{text = '●𝙱𝙰𝙲??↵', callback_data="/SOURCE_ELKIMA"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الــمــبــرمــج مـیـسـی', url="t.me/Messi_ElKBer"}},
{{text = 'تــواصــل مـیـسـی',url="t.me/ELKIMA_BOT"}}, 
{{text = '●𝙱𝙰𝙲𝙺↵', callback_data="/SOURCE_ELKIMA"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
