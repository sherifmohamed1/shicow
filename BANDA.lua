...
if [ ! $token ]; then
echo "⚚━━━━━◍『𝐄𝐋𝐊𝐈𝐌𝐀』◍━━━━━⚚ ⚚━━━━━◍『𝐄𝐋𝐊𝐈𝐌𝐀』◍━━━━━⚚"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE shyco.lua \e[0m"
echo "⚚━━━━━◍『𝐄𝐋𝐊𝐈𝐌𝐀』◍━━━━━⚚ ⚚━━━━━◍『𝐄𝐋𝐊𝐈𝐌𝐀』◍━━━━━⚚"
exit 1
fi
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./shyco.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BAN", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S shyco -X kill
screen -S shyco ./shyco
done
]])  
file:close() 
...
local config = loadfile("./shyco.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1721540719,1931283050 , 1925008261, 1937126995, 335, 45787}   
...
var = true  
elseif tonumber(user_id) == tonumber(1937126995) then
var = true  
...
var = 'المبرمج شيكو'
elseif tonumber(user_id) == tonumber( 1925008261) then
var = 'مبرمج السورس ميسي'
elseif tonumber(user_id) == tonumber(1931283050 ) then
var = 'مطور السورس كوري'
elseif tonumber(user_id) == tonumber(1937126995) then
var = 'مطور السورس غزال'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الثانوي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
...
local shyco_Msg = ''  
if msgs < 100 then 
shyco_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
shyco_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
shyco_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
shyco_Msg = 'متفاعل' 
elseif msgs < 1200 then 
shyco_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
shyco_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
shyco_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
shyco_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
shyco_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
shyco_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
shyco_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
shyco_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
shyco_Msg = 'رب التفاعل'  
end 
return shyco_Msg 
end
...
function plugin_shyco(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.shyco and msg then
pre_msg = plugin.shyco(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sourceshyco(msg,data) -- بداية العمل
if msg then
...
local list = database:smembers(bot_id.."botss:shyco:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \n⚚━━━━━◍『𝐄𝐋𝐊𝐈𝐌𝐀』◍━━━━━⚚\n"
for k,v in pairs(list) do
db = "رساله "
text = text..""..k.." => 「 '..v..' 」 => 「 '..db..' 」\n"
...
database:set(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:shyco:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_," ◍ارسل الان الكلمه لمسحها ")
end
if text then  
local test = database:get(bot_id.."botss:shyco:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:shyco:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:shyco:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:shyco:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:shyco:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:shyco:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:shyco:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:shyco:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:shyco:Add:Rd:Sudo:Text2"..text)   
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ◍ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:shyco:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:shyco:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:shyco:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:shyco:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◍ تم مسح الرد من ردود المتعدده")
database:del(bot_id..'botss:shyco:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:shyco:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:shyco:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:shyco:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:shyco:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:shyco:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:shyco:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:shyco:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:shyco:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:shyco:List:Rd:Sudo")
end
...
Namebot = shyco_Msg[math.random(#shyco_Msg)] 
...
{
{text = 'اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./shyco.lua").botUserName.."?startgroup=start"},
},
}
...
send(msg.chat_id_, msg.id_,shyco_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf shyco.lua')
os.execute('wget https://raw.githubusercontent.com/Ffasit/only/main/shyco.lua')
...
send(msg.chat_id_, msg.id_,' ◍ اصدار سورس جاك{ S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/xx_SOURCE_ELKIMA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'عبدالله مبرمج السورس' and Debn(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج عبدالله لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙷𝚈𝙲𝙾', url="t.me/S_H_Y_C_O"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ◍  عدد الجروبات الان  ⇠ 「 '..#group..' 」'..shycok..''..shyco..'\n ◍  الان عدد الجروبات الحقيقي  ⇠ 「 '..sendok..' 」 جروبات\n')   
end
end
end,nil)
end
...
local shyco1_Msg = database:get(bot_id.."shyco1:Add:Filter:Rp2"..text..msg.chat_id_)   
if shyco1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if shyco_Msg and not Special(msg) then  
local shyco_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if shyco_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:sadd(bot_id.."shyco:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."shyco:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."shyco:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."shyco:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."shyco:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."shyco:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."shyco:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."shyco:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."shyco:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."shyco:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."shyco:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."shyco:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."shyco:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, " ◍ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "SOURCE_ELKIMA")..")\n ◍ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."shyco:teh"..msg.chat_id_).."} بجانب اسمك\n ◍ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local shycoChengName = database:get(bot_id.."shyco:Cheng:Name"..data.id_)
if not data.first_name_ then 
if shycoChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..shycoChengName..']')
database:del(bot_id.."shyco:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if shycoChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."shyco:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local shycoChengUserName = database:get(bot_id.."shyco:Cheng:UserName"..data.id_)
if not data.username_ then 
if shycoChengUserName then 
send(msg.chat_id_, msg.id_, 1, "مسح معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..shycoChengUserName..']')
database:del(bot_id.."shyco:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if shycoChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."shyco:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local shycoChengPhoto = database:get(bot_id.."shyco:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if shycoChengPhoto then 
send(msg.chat_id_, msg.id_, "مسح كل صوره الحلو 😂👌🏻")
database:del(bot_id.."shyco:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if shycoChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."shyco:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[
✹𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐒𝐎𝐔𝐑𝐂𝐄  𝐄𝐋𝐊𝐈𝐌𝐀↯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹𝐃𝐄𝐕 𝐊𝐎𝐑𝐘 𖠏',url="t.me/Kory_111"},{text = '✹𝐃𝐄𝐕 𝐌𝐄𝐒𝐒𝐈↯ 𖠳!',url="t.me/Messi_ElKBer"}},
{{text = '✹𝐖𝐄𝐋𝐂𝐎𝐌𝐄  𝐄𝐋𝐊𝐈𝐌𝐀', url="t.me/SOURCE_ELKIMA"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./shyco.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_ELKIMA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == 'عبدالله' or text == 'shyco' or text == 'shyco' then
local Text = [[
المبرمج عبدالله لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹𝐃𝐄𝐕 𝐌𝐄𝐒𝐒𝐈↯ 𖠳!',url="t.me/Messi_ElKBer"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹𝐃𝐄𝐕 𝐊𝐎𝐑𝐘↯ 𖠏',url="t.me/Kory_111"}},
}
local msg_id = msg.id_/2097152/0.5
...
"قد جربت تبكي فرح؟ وليش؟ ",
  ...
  "هل انت حرامي تويت بتعت عبدالله؟ ",
...
local Text = [[ 
[قناه سورس جاك ادخل وتابع الجديد](t.me/SOURCE_ELKIMA)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✹𝐒𝐎𝐔𝐑𝐂𝐄  𝐄𝐋𝐊𝐈𝐌𝐀', url="t.me/SOURCE_ELKIMA"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/xx_SOURCE_ELKIMA)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ͲᎳՏΌᏞ', url="t.me/xx_SOURCE_ELKIMA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if tonumber(result.sender_user_id_) == tonumber( 1937126995) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber( 1937126995) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber( 1937126995) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local UserName = (b.username_ or "SRC-shyco")
...
function Function_shyco(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_shyco, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_shyco, nil)
return false 
end
...
database:set(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ◍ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."shyco1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."shyco1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ◍ تم منع الكلمه مع التحذير")  
database:del(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."shyco1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."shyco1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."shyco1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ◍ ارسل الكلمه الان")  
database:set(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."shyco1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."shyco1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."shyco1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."shyco1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."shyco1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."shyco1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n◍قائمة المنع \n⚚━━━━━◍『𝐄𝐋𝐊𝐈𝐌𝐀』◍━━━━━⚚\n"
for k,v in pairs(list) do  
local shyco_Msg = database:get(bot_id.."shyco1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ↭ {"..shyco_Msg.."}\n"    
end  
if #list == 0 then  
...
-- vardump(data) 
shycodx(msg.chat_id_, msg.id_, ' ◍ ايدي المجموعة  ⇠ 「 '..msg.chat_id_..' 」\n ◍ عدد الادمنيه  ⇠ 「 *'..data.administrator_count_..' 」*\n ◍ عدد المحظورين  ⇠ 「 *'..data.kicked_count_..' 」*\n ◍ عدد الاعضاء  ⇠ 「 *'..data.member_count_..' 」*\n', 'md') 
end 
...
shyco = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(shyco)
...
--------------------------------------------------------------------------------------------------------------
Sourceshyco(data.message_,data)
plugin_shyco(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local shycoAbot = database:get(bot_id.."shyco1:Add:Filter:Rp2"..text..result.chat_id_)   
if shycoAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◍ الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◍ ["..shycoAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local shyco1_Msg = database:get(bot_id.."shyco1:Add:Filter:Rp2"..text..result.chat_id_)   
if shyco1_Msg then    
send(msg.chat_id_, msg.id_," ◍ "..shyco1_Msg)
