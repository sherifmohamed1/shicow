...
if text == 'ميسيمبرمج السورس' and Debn(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج ميسيلو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙷 𝚈 𝙲 𝙾', url="t.me/S_H_Y_C_O"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹𝐃𝐄𝐕 𝐊𝐎𝐑𝐘',url="t.me/Oo_tiger"},{text = '✹𝐃𝐄𝐕 𝐌𝐄𝐒𝐒𝐈!',url="t.me/Messi_ElKBer"}},
{{text = '✹𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋𝐊𝐈𝐌𝐀', url="t.me/SOURCE_ELKIMA"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'شيكو' or text == 'Banda' or text == 'banda' then
local Text = [[
المبرمج ميسيلو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹𝐃𝐄𝐕 𝐊𝐎𝐑𝐘',url="t.me/Oo_tiger"}},
}
local msg_id = msg.id_/2097152/0.5
