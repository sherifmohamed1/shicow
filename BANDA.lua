...
sudo_users = {SUDO,1721540719,1931283050,1925008261}   
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ᴊᴏɪɴ➧ѕᴏᴏɴ˼', url="t.me/SOURCE_ELKIMA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qtdao/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
╔━━━━━━━━✧━━━━━━━╗  
┇🔰𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋𝐊𝐈𝐌𝐀(t.me/SOURCE_ELKIMA)⦒
🔰𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐄𝐋𝐘](t.me/SOURCE_ELKIMA)⦒
┇🔰𝐒𝐏𝐄𝐄𝐃 𝐀𝐂𝐂𝐔𝐑𝐀𝐂𝐘 𝐒𝐀𝐅𝐄𝐓𝐘(t.me/SOURCE_ELKIMA)⦒
╚━━━━━━━━✧━━━━━━━╝ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'تواصل قمه' or text == 'تاصل' or text == 'jdhdj' then
local Text = [[
المبرمج باندا لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝐃𝐕 𝐌𝐄𝐒𝐒𝐈˼',url="t.me/Messi_ElKBer"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝐃𝐕 𝐊𝐎𝐑𝐘˼',url="t.me/Bedo11111"}},
}
local msg_id = msg.id_/2097152/0.5
...
' }\n'..' ⦁  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⦁  الرفع  ↚ { '..setadd..
' }\n'..' ⦁  الحظر  ↚ { '..banm..' }\n\n ⦁☩━━━━━☩𝐄𝐋𝐊𝐈𝐌𝐀☩━━━━━☩\n ⦁ قناة سورس القمه↓\n [ ❲[𝐄𝐋𝐊𝐈𝐌𝐀](t.me/SOURCE_ELKIMA)❳](t.me/SOURCE_ELKIMA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
{
{text = '˹𝐣𝐨𝐢𝐧➧??𝐨𝐨𝐧˼', url="t.me/SOURCE_ELKIMA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
